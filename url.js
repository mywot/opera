...
$.extend(wot, { url: {
	...
	isequivalent: function(host)
	{
		try {
			...
			wot.log("url.isequivalent: failed with " + e + "\n", true);
		}
	...
	gethostname: function(url)
	{
		try {
			...
			wot.log("url.gethostname: failed with " + e + "\n", true);
		}
	...
	encodehostname: function(host, path)
	{
		try {
			...
			wot.log("url.encodehostname: failed with " + e + "\n", true);
		}
	...
	decodehostname: function(host)
	{
		try {
			...
			wot.log("url.decodehostname: failed with " + e + "\n", true);
		}
	...
	isencodedhostname: function(host)
	{
		try {
			...
			wot.log("url.isencodedhostname: failed with " + e + "\n", true);
		}
	...
	base32: {
		...
		encode: function(s)
		{
			try {
				...
				wot.log("base32.encode: failed with " + e + "\n", true);
			}
		...
		decode: function(s)
		{
			try {
				...
				wot.log("base32.decode: failed with " + e + "\n", true);
			}
	...
	isetld: function(host)
	{
		try {
			...
			wot.log("url.isetld: failed with " + e + "\n", true);
		}
